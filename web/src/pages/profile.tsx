    ...
    <div class="container mx-auto px-4 pb-24 pt-4 h-screen overflow-y-auto">
      <div class="flex flex-col items-center py-6">
        <div class="relative mb-6">
          ...
          <p
            class="h-7 bg-muted rounded-xl flex items-center justify-center w-full text-sm text-secondary-foreground text-center mt-4">
                ...
                {option => {
                  ...
                  return (
                    <button
                      ...
                      class={`flex border items-center justify-between p-3 rounded-md 
                    ...
                    >
                      ...
                      <span class={`w-5 h-5 flex items-center justify-center border border-primary rounded-full 
